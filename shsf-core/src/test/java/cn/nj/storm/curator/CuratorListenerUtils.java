...
//                authorization(scheme, auth).
    ...
    private static void addProvider(CuratorFramework client){
        String detailPath = "/cn.nj.storm.shsf.app.api.service.IHappyService/provider/127.0.0.1:20881";
        String serviceDetail = "shsf://127.0.0.1:20881?interface=cn.nj.storm.shsf.app.api.service.IHappyService&retries=3&timeout=3000&type=provider&methods=[makeHappy, happyName]";
        try {
            client.create()
...
//                        case NODE_ADDED:
//                            String dataStr = data.getData() != null ? new String(data.getData()) : "";
//                            System.out.println("NODE_ADDED : " + data.getPath() + "  数据:" + dataStr);
//                            break;
//                        case NODE_REMOVED:
